...
extension Device {
  static let standardResolution = Device(code: "SR", group: nil, name: "Standard Res", width: 1200, height: 1920)
  static let highResolution = Device(code: "HR", group: nil, name: "High Res", width: 2400, height: 3840)
  ...
  static let all: [Device] = [
    ...
    Device(code: "KV", group: "kindle", name: "Kindle Paperwhite 3/4/Voyage/Oasis", width: 1072, height: 1448),
    Device(code: "KPW5", group: "kindle", name: "Kindle Paperwhite 5/Signature Edition", width: 1236, height: 1648),
    ...
    Device(code: "KoC", group: "kobo", name: "Kobo Clara HD/Kobo Clara 2E", width: 1072, height: 1448),
    Device(code: "KoL", group: "kobo", name: "Kobo Libra H2O/Kobo Libra 2", width: 1264, height: 1680),
